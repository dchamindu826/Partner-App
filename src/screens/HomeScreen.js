...
const styles = StyleSheet.create({
  ...
  profileImage: {
    ...
    borderWidth: 2, borderColor: COLORS.white, marginRight: 15
  },
  headerText: { flex: 1 },
  ...
  redDot: {
    ...
    borderRadius: 5, backgroundColor: 'red', borderWidth: 1, borderColor: COLORS.white
  },
  contentContainer: {
  ...
  quickActionCard: {
    width: 100, height: 100, backgroundColor: COLORS.white, borderRadius: 15,
    justifyContent: 'center', alignItems: 'center', elevation: 3,
    shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 3, marginRight: 15,
  },
